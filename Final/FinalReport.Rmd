...
A new model was generated using the variables of greatest importance. The mean decrease gini was plotted to determine the most important features, the AUC was calculated, and a ROC curve generated to assess the results of the model.
```{r, echo=FALSE}
