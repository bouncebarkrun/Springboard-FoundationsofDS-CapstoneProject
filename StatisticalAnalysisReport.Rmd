...
The full datset was initially evaluated with the summary command to review the variables and their basic statistics.
...
To further explore factors around the NHL draft, tables were generated to summarize draft round and draft age by birth country.
...
This graph may suggest that the SouthEast (SE) division is more hit-or-miss in terms of making the playoffs than the NorthEast (NE) division prior ot the 2004 lockout or the Atlantic (AT) division in the years after the lockout.
